...
def main():
    ...
    if save_file == 'Y':
        ...
        # Clean up in case the student typed .csv or .html anyway
        ...
        # Explicitly append the correct extensions
        ...
        # Print distinct file names so students know exactly what was generated
        print("\n" + "="*80)
